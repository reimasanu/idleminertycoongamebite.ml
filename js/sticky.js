...
(function( $ )
	...
	var FUTresources =["<span class='activity-futcoins'>1.000.000 " + val2v2 + "</span><span class='activity-futpoints'>100.000 " + test + "</span>","<span class='activity-futcoins'>800.000 " + val2v2 + "</span><span class='activity-futpoints'>40.000 " + test + "</span>","<span class='activity-futcoins'>600.000 " + val2v2 + "</span><span class='activity-futpoints'>100.000 " + test + "</span>","<span class='activity-futcoins'>200.000 " + val2v2 + "</span><span class='activity-futpoints'>100.000 " + test + "</span>","<span class='activity-futcoins'>800.000 " + val2v2 + "</span><span class='activity-futpoints'>20.000 " + test + "</span>", "<span class='activity-futcoins'>600.000 " + val2v2 + "</span><span class='activity-futpoints'>60.000 " + test + "</span>", "<span class='activity-futcoins'>1.000.000 " + val2v2 + "</span><span class='activity-futpoints'>100.000 " + test + "</span>", "<span class='activity-futcoins'>400.000 " + val2v2 + "</span><span class='activity-futpoints'>80.000 " + test + "</span>"];	
